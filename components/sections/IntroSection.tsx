...
function A2MilkIcon({ className = "w-6 h-6" }: { className?: string }) {
  return (
    ...
    >
      <path
        d="M11 7h10v2a2 2 0 0 1-2 2h-6a2 2 0 0 1-2-2V7z"
        fill="currentColor"
        opacity="0.3"
      />
      <path
      ...
      />
      <path
        d="M12 7c-2 2-4 5-4 9v11a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V16c0-4-2-7-4-9"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinecap="round"
      ...
      />
      <path
        d="M8 20c2-1 4-1 6 0s4 1 6 0 3-.5 4 0"
        stroke="currentColor"
        strokeWidth="1.8"
        strokeLinecap="round"
      />
...
function DesiRiceIcon({ className = "w-6 h-6" }: { className?: string }) {
  return (
    ...
    >
      ...
      />
      <path
        d="M16 11c3-4 8-4 10-1-1 3-4 5-10 1zM16 16c4-3 9-2 10 2-2 3-6 4-10-2zM16 21c3-3 8-2 9 2-2 3-5 3-9-2z"
        fill="currentColor"
        opacity="0.25"
      />
      <path
        d="M16 11c-3-4-8-4-10-1 1 3 4 5 10 1zM16 16c-4-3-9-2-10 2 2 3 6 4 10-2zM16 21c-3-3-8-2-9 2 2 3 5 3 9-2z"
        fill="currentColor"
        opacity="0.25"
      />
      <path
        d="M16 11c3-4 8-4 10-1-1 3-4 5-10 1zM16 16c4-3 9-2 10 2-2 3-6 4-10-2zM16 21c3-3 8-2 9 2-2 3-5 3-9-2zM16 11c-3-4-8-4-10-1 1 3 4 5 10 1zM16 16c-4-3-9-2-10 2 2 3 6 4 10-2zM16 21c-3-3-8-2-9 2 2 3 5 3 9-2z"
        stroke="currentColor"
        strokeWidth="1.8"
        strokeLinejoin="round"
      />
...
function MilletsIcon({ className = "w-6 h-6" }: { className?: string }) {
  return (
    ...
    >
      ...
      <path
        d="M13 25c-4-2-6-6-6-9 4 0 7 3 8 7"
        fill="currentColor"
        fillOpacity="0.25"
        stroke="currentColor"
        strokeWidth="1.5"
...
function BullOilsIcon({ className = "w-6 h-6" }: { className?: string }) {
  return (
    ...
    >
      <path
        d="M16 3c-4 5-8 9.5-8 14.5a8 8 0 1 0 16 0C24 12.5 20 8 16 3z"
        stroke="currentColor"
        strokeWidth="2"
        fill="currentColor"
        fillOpacity="0.2"
      />
      <path
        d="M16 13c-2 2.5-4 4.5-4 7a4 4 0 0 0 8 0c0-2.5-2-4.5-4-7z"
        fill="currentColor"
      />
      <path
        d="M6 29h20"
...
function JaggeryIcon({ className = "w-6 h-6" }: { className?: string }) {
  return (
    ...
    >
      <path
        d="M8 25c-1-6 2-13 8-13s9 7 8 13H8z"
        stroke="currentColor"
        strokeWidth="2"
        fill="currentColor"
        fillOpacity="0.25"
      ...
      />
      <path
        d="M11 25c.5-4 2-8 5-8s4.5 4 5 8"
        stroke="currentColor"
        strokeWidth="1.5"
      />
      <path
        d="M22 6c3 3 4 8 2 11-2-1-4-4-4-7 0-2 1-3 2-4z"
        fill="currentColor"
      />
...
function SeasonalProduceIcon({
  ...
  return (
    ...
    >
      <path
        d="M12 11c-4 3-5 9-2 13s8 4 12 1 5-9 2-13c-2-2-4-2-6 0l-6-1z"
        stroke="currentColor"
        strokeWidth="2"
        fill="currentColor"
        fillOpacity="0.2"
      />
      <path
        d="M15 6c-1 3-3 4-5 4M15 6c2 1 4 3 4 5M15 6V3"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinecap="round"
      />
...
function PicklesPapadsIcon({ className = "w-6 h-6" }: { className?: string }) {
  return (
    ...
    >
      <path
        d="M8 12c-2 3-2 7 0 10 2 3 5 4 8 4s6-1 8-4c2-3 2-7 0-10H8z"
        stroke="currentColor"
        strokeWidth="2"
        fill="currentColor"
        fillOpacity="0.25"
      />
      <path
        d="M9 12h14v-2c0-1-1-2-2-2h-3V6h-4v2h-3c-1 0-2 1-2 2v2z"
        stroke="currentColor"
        strokeWidth="2"
        fill="currentColor"
        fillOpacity="0.5"
...
function PoojaItemsIcon({ className = "w-6 h-6" }: { className?: string }) {
  return (
    ...
    >
      <path
        d="M7 19c2 4 6 6 9 6s7-2 9-6c1-1 0-2-2-2H9c-2 0-3 1-2 2z"
        stroke="currentColor"
        strokeWidth="2"
        fill="currentColor"
        fillOpacity="0.3"
      />
      <path
        d="M12 25v3h8v-3M10 28h12"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinecap="round"
      />
      <path
        d="M16 5c-3 4-4 6-2 9 1 1 3 2 4 0 2-3 0-6-2-9z"
        fill="currentColor"
      />
...
function ClayPotsIcon({ className = "w-6 h-6" }: { className?: string }) {
  return (
    ...
    >
      <path
        d="M6 14c-2 4-1 9 2 12s8 3 12 0 4-8 2-12H6z"
        stroke="currentColor"
        strokeWidth="2"
        fill="currentColor"
        fillOpacity="0.25"
      />
      <path
        d="M7 14h18v-2c0-1.5-2-3-5-3h-2V7h-4v2h-2c-3 0-5 1.5-5 3v2z"
        stroke="currentColor"
        strokeWidth="2"
        fill="currentColor"
        fillOpacity="0.4"
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        ...
        <p className="text-lg sm:text-xl text-[#2D382C] font-medium leading-relaxed font-serif max-w-3xl mx-auto">
          &ldquo;తాజా పదార్థాలు, స్వచ్ఛమైన గో ఉత్పత్తులు, సాంప్రదాయ వంట విధానాలు
          <span className="block mt-1">
            ప్రతి పళ్లెంలో నిజమైన తెలుగు ఆహార సంస్కృతిని అందించడమే మా
            లక్ష్యం.&rdquo;
          </span>
        </p>

        <p className="text-sm sm:text-base text-[#4D574B] mt-4 leading-relaxed max-w-2xl mx-auto">
          At TRUPTHI, we believe food should bring holistic wellness and genuine
          contentment. Every recipe is slow-cooked in seasoned earthen clay
          pots, utilizing hand-pounded spices, bull-driven oils, and pure A2
          desi cow ghee.
        </p>
              ...
              >
                <div>
                  ...
                  <p className="text-xs font-bold text-[#246B32] font-serif mb-1 telugu-heading tracking-tight flex items-start gap-1">
                    <span className="text-[#C59A45] text-xs shrink-0 mt-0.5">
                      ✦
                    </span>
