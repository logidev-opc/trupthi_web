  ...
  return (
    ...
    >
      ...
      <button
        ...
        type="button"
        className="absolute top-6 right-6 z-30 px-4 py-1.5 rounded-full bg-black/40 hover:bg-black/70 border border-white/20 text-white/80 hover:text-white text-xs font-medium tracking-wider backdrop-blur-md transition-all cursor-pointer"
